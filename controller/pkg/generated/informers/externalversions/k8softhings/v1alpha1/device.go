...
import (
	...
	k8softhingsv1alpha1 "github.com/jpbetz/KoT/controller/pkg/apis/k8softhings/v1alpha1"
	versioned "github.com/jpbetz/KoT/controller/pkg/generated/clientset/versioned"
	internalinterfaces "github.com/jpbetz/KoT/controller/pkg/generated/informers/externalversions/internalinterfaces"
	v1alpha1 "github.com/jpbetz/KoT/controller/pkg/generated/listers/k8softhings/v1alpha1"
	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.K8softhingsV1alpha1().Devices(namespace).List(options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.K8softhingsV1alpha1().Devices(namespace).Watch(options)
			},
		},
		&k8softhingsv1alpha1.Device{},
		resyncPeriod,
		indexers,
	)
}
...
func (f *deviceInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&k8softhingsv1alpha1.Device{}, f.defaultInformer)
}
