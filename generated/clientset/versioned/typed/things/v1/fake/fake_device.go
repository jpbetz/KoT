...
func (c *FakeDevices) Get(name string, options v1.GetOptions) (result *thingsv1.Device, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewGetAction(devicesResource, c.ns, name), &thingsv1.Device{})

	if obj == nil {
		return nil, err
	}
	return obj.(*thingsv1.Device), err
}

// List takes label and field selectors, and returns the list of Devices that match those selectors.
func (c *FakeDevices) List(opts v1.ListOptions) (result *thingsv1.DeviceList, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewListAction(devicesResource, devicesKind, c.ns, opts), &thingsv1.DeviceList{})
	...
	list := &thingsv1.DeviceList{ListMeta: obj.(*thingsv1.DeviceList).ListMeta}
	for _, item := range obj.(*thingsv1.DeviceList).Items {
...
func (c *FakeDevices) Create(device *thingsv1.Device) (result *thingsv1.Device, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewCreateAction(devicesResource, c.ns, device), &thingsv1.Device{})
...
func (c *FakeDevices) Update(device *thingsv1.Device) (result *thingsv1.Device, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewUpdateAction(devicesResource, c.ns, device), &thingsv1.Device{})
...
func (c *FakeDevices) UpdateStatus(device *thingsv1.Device) (*thingsv1.Device, error) {
	obj, err := c.Fake.
		Invokes(testing.NewUpdateSubresourceAction(devicesResource, "status", c.ns, device), &thingsv1.Device{})
...
func (c *FakeDevices) Delete(name string, options *v1.DeleteOptions) error {
	_, err := c.Fake.
		Invokes(testing.NewDeleteAction(devicesResource, c.ns, name), &thingsv1.Device{})
...
func (c *FakeDevices) DeleteCollection(options *v1.DeleteOptions, listOptions v1.ListOptions) error {
	...
	_, err := c.Fake.Invokes(action, &thingsv1.DeviceList{})
	return err
}

// Patch applies the patch and returns the patched device.
func (c *FakeDevices) Patch(name string, pt types.PatchType, data []byte, subresources ...string) (result *thingsv1.Device, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewPatchSubresourceAction(devicesResource, c.ns, name, pt, data, subresources...), &thingsv1.Device{})
