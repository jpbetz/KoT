...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *ModuleDevices) DeepCopyInto(out *ModuleDevices) {
	*out = *in
	return
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new ModuleDevices.
func (in *ModuleDevices) DeepCopy() *ModuleDevices {
	if in == nil {
		return nil
	}
	out := new(ModuleDevices)
	in.DeepCopyInto(out)
	return out
}
